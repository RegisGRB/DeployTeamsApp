...
export interface ITeamsTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITeamsTabRemoveProps extends ITeamsBaseComponentProps {

}

/**
 * Implementation of teams Tab remove page
 */
export class TeamsTabRemove  extends TeamsBaseComponent<ITeamsTabRemoveProps, ITeamsTabRemoveState> {
